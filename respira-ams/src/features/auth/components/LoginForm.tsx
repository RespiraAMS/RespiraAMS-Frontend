				...
				<form className="space-y-5">
					...
					<div className="space-y-2">
						...
						<div className="relative">
							...
							<Input
								...
								className="h-12 pl-10 text-[15px] border-[1.5px] border-slate-300 focus-visible:ring-cyan-500/20 focus-visible:border-cyan-500/60"
							/>
						</div>
					</div>
					...
					<div className="space-y-2">
						...
						<div className="relative">
							...
							<Input
								...
								className="h-12 pl-10 pr-12 text-[15px] border-[1.5px] border-slate-300 focus-visible:ring-cyan-500/20 focus-visible:border-cyan-500/60"
							/>
							<Button
								type="button"
								variant="ghost"
								...
								className="absolute right-1 top-1/2 -translate-y-1/2 h-9 w-9 text-muted-foreground/60 hover:text-foreground"
							>
								{showPassword ? (
					...
					<div className="flex items-center justify-between pt-1">
						...
						<Button
							type="submit"
							disabled={isLoading}
							className="gap-2 bg-cyan-600 text-white hover:bg-cyan-500 px-8 h-10"
						>
							{isLoading ? (
